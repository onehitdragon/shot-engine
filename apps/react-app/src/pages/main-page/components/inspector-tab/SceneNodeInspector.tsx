...
import { selectComponentRecord, selectSceneNodeById } from "../../../../global-state/slices/scene-manager-slice";
...
import { componentUpdatedThunk } from "../../../../global-state/thunks/scene-manager-thunks";
        ...
        <div className="flex flex-col">
            ...
            <div className="flex flex-col">
                <ThreeValueRow
                    ...
                    onChange={(value) => {
                        dispatch(componentUpdatedThunk({
        ...
        <div className="flex flex-col gap-2">
            ...
            }
            {
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <TextRow label="fileName" content={getBaseName(resource.path)}/>
